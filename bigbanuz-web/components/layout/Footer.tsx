...
export default function Footer() {
  ...
  return (
    <footer dir="ltr" className="bg-deep text-white py-12" role="contentinfo">
      <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Brand + tagline */}
          <div className="text-center md:text-left">
            <div className="font-heading text-xl font-bold tracking-tight">{t("brand")}</div>
            <p className="text-white/40 text-caption mt-1">{t("tagline")}</p>
          </div>
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="text-white/70 hover:text-ocean-light transition-colors duration-300"
