        ...
        <div className="mx-auto max-w-content px-4 text-center">
          <ScrollReveal>
            ...
            <a
              ...
              className="inline-flex items-center gap-4 rounded-xl bg-ocean px-14 py-6 text-h2 font-bold text-white shadow-lg transition-all hover:bg-ocean-dark hover:shadow-xl hover:scale-[1.02]"
            >
